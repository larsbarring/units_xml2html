        ...
        <html lang="en">
            <head>
                <meta charset="UTF-8"/>
                    <xsl:choose>
                    <xsl:when test="//base">
                        <title>UDUNITS2: SI Base Units</title>
                    </xsl:when>
                    <xsl:when test="//unit/comment[starts-with(., 'SI derived unit')]">
                        <title>UDUNITS2: SI Derived Units</title>
                    </xsl:when>
                    <xsl:otherwise>
                        <title>UDUNITS2: Units Accepted for use with SI</title>
                    </xsl:otherwise>
                    </xsl:choose>
                <style>
                    body {
